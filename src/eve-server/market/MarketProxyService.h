...
protected:
    ...
    PyResult ModifyCharOrder(PyCallArgs& call, PyInt* orderID, PyFloat* newPrice, PyBool* bid, PyInt* stationID, PyInt* solarSystemID, PyFloat* price, PyInt* range, PyInt* volRemaining, PyLong* issueDate);
