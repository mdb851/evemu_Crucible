...
- **`DeleteContract`:** items are **`ChangeOwner`** back to **`GetCorporationID()`** when the contract row has **`forCorp`**, matching create/accept corp inventory semantics.
